...
FbLinearizer::FbLinearizer(){
    ...
    this->_input_port_1 = new InputPort(ports_id::IP_X_DOT, this);
    this->_input_port_2 = new InputPort(ports_id::IP_ROLL, this);
    this->_input_port_3 = new InputPort(ports_id::IP_PITCH, this);
    this->_input_port_4 = new InputPort(ports_id::IP_YAW, this);
    this->_input_port_5 = new InputPort(ports_id::IP_YAW_REF, this);
    this->_input_port_6 = new InputPort(ports_id::IP_FHX_DES, this);

    this->_output_port_xh = new OutputPort(ports_id::OP_XH, this);
    this->_output_port_xh_dot = new OutputPort(ports_id::OP_XH_DOT, this);
    ...
    _ports = {_input_port_0, _input_port_1, _input_port_2, _input_port_3, _input_port_4, _input_port_5, _input_port_6, _output_port_xh, _output_port_xh_dot, _output_port_rot_err, _output_port_z_com};
...
void FbLinearizer::process(DataMsg* t_msg, Port* t_port){
    if(t_port->getID() == ports_id::IP_X){
        ...
        auto R_B_B_des = R_B_I.transposeTimes(R_B_des_I);
        tf2::Quaternion quat;
...
void FbLinearizer::force2angles(tf2::Vector3 F_I_des){
    ...
    R_B_des_I = tf2::Matrix3x3(x_B_des.x(), x_B_des.y(), x_B_des.z(),
